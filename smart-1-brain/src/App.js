...
this.setState({input: event.target.value});
  ...
  onButtonSubmit = () =>{
   ...
   fetch('  https://thawing-earth-10562.herokuapp.com/imageurl',{
    method: 'post',
   ...
   .then(response => response.json())
       .then(response =>{
         if(response){
           fetch('https://thawing-earth-10562.herokuapp.com/image',{
            method: 'put',
            headers: {'Content-Type' : 'application/json'},
            body :JSON.stringify({
...
this.setState({isSignedIn: true})
  ...
  <div className='App'>
    ...
    /> 
<Navgation isSignedIn={isSignedIn} onRoutChange={this.onRoutChange}/>
{route === 'home' 
? 
<div> 
<Logo />
